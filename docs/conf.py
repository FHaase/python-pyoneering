...
htmlhelp_basename = 'pyoneeringdoc'
...
latex_documents = [
    (master_doc, 'pyoneering.tex', 'pyoneering Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'pyoneering', 'pyoneering Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyoneering', 'pyoneering Documentation',
     author, 'pyoneering', 'One line description of project.',
     'Miscellaneous'),
]
